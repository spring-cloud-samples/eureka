...
import org.springframework.platform.netflix.eureka.event.EurekaInstanceRenewedEvent;
...
public class EurekaInstanceRenewedListener implements ApplicationListener<EurekaInstanceRenewedEvent> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(EurekaInstanceRenewedListener.class);
